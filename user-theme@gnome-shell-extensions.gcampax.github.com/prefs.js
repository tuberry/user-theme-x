...
class UserThemePrefsWidget extends Gtk.ScrolledWindow {
    _init() {
        ...
        let label = new Gtk.Label({
            ...
            label: 'Load user stylesheet',
        });
        this._switch = new Gtk.Switch();
        this._settings.bind('stylesheet', this._switch, 'active', Gio.SettingsBindFlags.DEFAULT);
        hbox.pack_start(label, true, true, 60);
        hbox.pack_start(this._switch, false, false, 60);
        box.add(hbox);
